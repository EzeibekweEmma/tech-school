  ...
  <section class="flex justify-between items-center h-16 w-[85vw]">
    ...
    <section class="flex space-x-2">
      ...
      <section class="flex items-center justify-center text-emerald-700 font-semibold space-x-3">
        ...
        <a href="../../src/auth/login.php" class="flex justify-center rounded-lg items-center border-2 duration-700 hover:bg-emerald-700 hover:text-white border-emerald-700 space-x-1 px-1.5 py-1">
          <div class="w-8 h-8">
