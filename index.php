    ...
    <main class="flex items-center justify-center">
      <section class="flex flex-col items-center w-[85vw]">
        <section class="my-16">
          ...
          <p class="text-center text-base sm:text-lg md:text-xl font-medium">At <span
        ...
        <section class="flex justify-between items-center mb-16">
          <div class=" mr-10 ">
            ...
            <img class="rounded-3xl block mb-3 md:hidden" width="100%" src="./src\assets\operator.png" alt="">
          ...
          <img class="rounded-3xl hidden md:block" width="40%" src="./src\assets\operator.png" alt="">
        </section>
