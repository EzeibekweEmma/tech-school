        ...
        <section class="flex flex-col items-center mb-16">
          ...
          <div class="flex justify-around flex-wrap items-center w-screen p-10 bg-white/50">
            <span class="hover:cursor-none h-12 md:h-16 w-28 ms:w-32 mx-5">
              <img src="./src/assets/amazon-logo.png" draggable="false" class="h-full w-full" alt="amazon logo">
            </span>
            <span class="hover:cursor-none h-16 md:h-20 w-16 md:w-20 mx-5">
              <img src="./src/assets/google-logo.png" draggable="false" class="h-full w-full" alt="google logo">
            </span>
            <span class="hover:cursor-none h-16 md:h-20 w-28 mx-5">
              <img src="./src/assets/mastercard-logo.png" draggable="false" class="h-full w-full" alt="mastercard logo">
            </span>
            <span class="hover:cursor-none h-20 md:h-24 w-32 md:w-36 mx-5">
              <img src="./src/assets/microsoft-logo.png" draggable="false" class="h-full w-full" alt="microsoft logo">
            </span>
            <span class="hover:cursor-none h-8 md:h-12 w-8 md:w-12 mx-5">
              <img src="./src/assets/x-logo.png" draggable="false" class="h-full w-full" alt="x logo">
            </span>
            <span class="hover:cursor-none h-20 md:h-24 w-32 md:w-36 mx-5">
              <img src="./src/assets/meta-logo.png" draggable="false" class="h-full w-full" alt="meta logo">
            </span>
            <span class="hover:cursor-none h-16 md:h-20 w-16 md:w-20 mx-5">
              <img src="./src/assets/tesla-logo.png" draggable="false" class="h-full w-full" alt="tesla logo">
            </span>
          </div>
        </section>
