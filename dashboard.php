  ...
  <div class="flex flex-col justify-between min-h-screen">
    ...
    ';
      ...
      <div class="absolute bottom-2 right-2">
        <a href="./edit-dashboard.php"
          class="bg-white hover:bg-white/70 hover:rotate-[360deg] duration-700 text-emerald-700 p-2 rounded-full font-medium flex items-center">
    ...
    <main class="flex flex-col items-center justify-center relative">
      <section class="flex flex-col w-[85vw]">
        ...
        <section
          class="flex flex-col md:flex-row justify-center md:justify-start items-center md:items-end -mt-16 md:-mt-24 duration-700 space-x-5 mb-10">
          <div
            class="w-48 md:w-60 h-48 md:h-60 border-4 duration-700 border-white rounded-full bg-white text-emerald-800">
            <?php
